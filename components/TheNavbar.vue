<template>
  <div class="navbar-container">
    <div class="content" :class="{ 'content-bg' : scrollPosition >= 10, 'text-gray-600' : scrollPosition < 10 && !noHero }">
...
/>
        ...
        <div class="hidden lg:block">
          <nav-items class="nav-items" :class="{ 'text-gray-600' : scrollPosition < 10 && !noHero }" />
        </div>
...
<style scoped>
  ...
  .content-bg {
    @apply bg-[#9FC9C3] h-20 text-gray-600;
  }
